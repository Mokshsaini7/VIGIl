      ...
      <div className="h-full px-3 sm:px-5 lg:px-6 flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
          ...
          <div className="min-w-0 flex-1">
            <h2 className="text-xs sm:text-sm lg:text-lg font-semibold text-white tracking-wide truncate">
              {title}
            </h2>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5 flex-shrink-0">
          ...
          >
            ...
            {/* Wifi Icon */}
            <Wifi className="hidden sm:block w-3.5 h-3.5 text-emerald-400" />

            {/* Desktop Text */}
            <span className="hidden sm:inline text-[10px] lg:text-xs text-gray-300 font-mono">
              WebSocket: Live
            </span>

            {/* Mobile Text */}
            <span className="sm:hidden text-[9px] text-emerald-400 font-mono font-bold">
              LIVE
            </span>
          </div>
          ...
          <div
            className="
              flex items-center
              gap-1.5 sm:gap-3
              border-l border-[#26334D]
              pl-1.5 sm:pl-3 lg:pl-4
            "
          >
